...
|返回字段|字段类型|说明|
|:---|:---|:---|
|paymentCode|string|支付方式code|
|paymentDes|string|支付方式名称|
|amount|double|微信金额|
...
``` json
{
    "data": [{"paymentCode": "wx", "paymentDes": "微信支付", "amount": 1},
            {"paymentCode": "ali", "paymentDes": "支付宝支付", "amount": 1},
            {"paymentCode": "scan", "paymentDes": "付款码支付", "amount": 1},
            {"paymentCode": "cash", "paymentDes": "现金支付", "amount": 1}],
    "code": 200,
    "msg": "OK"
}
```
